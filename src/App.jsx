    ...
    if (!trimmedTitulo || !trimmedAutor || !trimmedGenero) {
      ...
      setInvalidFields(
        ['formTodo', 'formDescription', 'formGenre']
          .filter((field) => !trimmedTitulo && field === 'formTodo')
          .concat(
            ['formTodo', 'formDescription', 'formGenre']
              .filter((field) => !trimmedAutor && field === 'formDescription')
              .concat(
                ['formTodo', 'formDescription', 'formGenre'].filter((field) => !trimmedGenero && field === 'formGenre')
              )
          )
      );
      return;
  ...
  const handleSubmitChange = () => {
    ...
    if (!trimmedTitulo || !trimmedAutor || !trimmedGenero) {
      ...
      return;
        ...
        const titleExists = livros.some(
          (todo) => todo.todo === trimmedTitulo && todo.uuid !== tempUuid
        );
